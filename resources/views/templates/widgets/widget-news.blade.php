...
<div class="panel widget vd_news-widget">
  <div class="panel-body-list">
    <?php include(resource_path('views').'/templates/widgets/panel-menu-widget-no-minimize.blade.php'); ?> 
    ...
    <div class="vd_carousel">
      <div class="vd_carousel-column" style="background:url({{ asset('img/photos/news-blur.jpg') }});">
          ...
          <div class="content-list content-image ">
            <div class="list-wrapper">
              <div class="comment-content">
                <div class="menu-icon"><a href="#"><img src="{{ asset('img/avatar/avatar.jpg') }}" alt="example image"></a></div>
      ...
      <div class="vd_carousel-column" style="background:url({{ asset('img/photos/news-blur-02.jpg') }});">
        <div class="news-list pd-20 vd_white  font-light"> <br />
          <br />
          <br />
          <br />
        ...
        <div class="comment-list pd-20 vd_bg-white">
          <div class="content-list content-image ">
            <div class="list-wrapper">
              <div class="comment-content">
                <div class="menu-icon"><a href="#"><img src="{{ asset('img/avatar/avatar-2.jpg') }}" alt="example image"></a></div>
      ...
      <div class="vd_carousel-column" style="background:url({{ asset('img/photos/news-blur-03.jpg') }});">
        <div class="news-list pd-20 vd_white font-light"> <br />
          <br />
          <br />
          <br />
        ...
        <div class="comment-list pd-20 vd_bg-white">
          <div class="content-list content-image ">
            <div class="list-wrapper">
              <div class="comment-content">
                <div class="menu-icon"><a href="#"><img src="{{ asset('img/avatar/avatar-3.jpg') }}" alt="example image"></a></div>
