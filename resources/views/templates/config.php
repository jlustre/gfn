...
/*  GENERAL SETTING  */
	...
	$author = 'AsBeez Inc'; // for author meta data: <meta name="author" content="$author; ">
	$website_name = 'AsBeez'; // for closing title every page: <title>$title;  | $website_name;</title>
	$footer_message = 'Copyright &copy;2019 AsBeez Inc. All Rights Reserved'; // Set Copyright message on footer
...
/*  HEADER AND FOOTER SETTING  */
	...
	$footer = 'footer-2'; // 'footer-1' or 'footer-2' or 'footer-3' or 'footer-4' ,or other 'header-*' located at templates/footers/$footer.tpl.php
...
/*  EXTRA CLASS SETTING  */	
	...
	$top_menu_extra_class = 'menu-search-style-2';  // background class such as 'vd_bg-white', also 'light-top-menu', 'menu-search-style-2'	
