<script type="text/javascript" src="<?php echo asset('plugins/raphael/raphael.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/morris/morris.min.js'); ?>"></script>
