...
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.resize.js'); ?>"></script>
...
<!-- Sparkline -->
<script type="text/javascript" src='<?php echo asset('plugins/sparkline/jquery.sparkline.min.js'); ?>'></script>
