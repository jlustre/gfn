<!-- Flot Chart  -->
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.resize.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.pie.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.categories.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.time.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/flot/jquery.flot.animator.min.js'); ?>"></script>

<!-- Vector Map -->
<script type="text/javascript" src="<?php echo asset('plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/jvectormap/jquery-jvectormap-world-mill-en.js'); ?>"></script>

<!-- Calendar -->
<script type="text/javascript" src='<?php echo asset('plugins/moment/moment.min.js'); ?>'></script>
...
<!-- Intro JS (Tour) -->
<script type="text/javascript" src='<?php echo asset('plugins/introjs/js/intro.min.js'); ?>'></script>

<!-- Sky Icons -->
<script type="text/javascript" src='<?php echo asset('plugins/skycons/skycons.js'); ?>'></script>
