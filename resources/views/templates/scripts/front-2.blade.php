...
<script src="<?php echo asset('plugins/layerslider/js/greensock.js'); ?>" type="text/javascript"></script>
<!-- LayerSlider script files -->
<script src="<?php echo asset('plugins/layerslider/js/layerslider.transitions.js'); ?>" type="text/javascript"></script>
<script src="<?php echo asset('plugins/layerslider/js/layerslider.kreaturamedia.jquery.js'); ?>" type="text/javascript"></script>
