<script type="text/javascript" src='<?php echo asset('plugins/tagsInput/jquery.tagsinput.min.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/bootstrap-timepicker/bootstrap-timepicker.min.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/daterangepicker/moment.min.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/daterangepicker/daterangepicker.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/colorpicker/colorpicker.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/ckeditor/ckeditor.js'); ?>'></script>
<script type="text/javascript" src='<?php echo asset('plugins/ckeditor/adapters/jquery.js'); ?>'></script>
<script type="text/javascript" src="<?php echo asset('plugins/bootstrap-wysiwyg/js/wysihtml5-0.3.0.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo asset('plugins/bootstrap-wysiwyg/js/bootstrap-wysihtml5-0.0.2.js'); ?>"></script>
...
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.iframe-transport.js'); ?>"></script>
<!-- The basic File Upload plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload.js'); ?>"></script>
<!-- The File Upload processing plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload-process.js'); ?>"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload-image.js'); ?>"></script>
<!-- The File Upload audio preview plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload-audio.js'); ?>"></script>
<!-- The File Upload video preview plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload-video.js'); ?>"></script>
<!-- The File Upload validation plugin -->
<script src="<?php echo asset('plugins/jquery-file-upload/js/jquery.fileupload-validate.js'); ?>"></script>
<script>
