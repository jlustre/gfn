<div class="vd_navbar vd_nav-width navbar-1 <?php if (isset($current_navbar)) {echo($current_navbar);} ?> <?php if (isset($navbar_style)) {echo($navbar_style);} ?>">
            ...
            <div class="menu-container">
            	<div class="vd_mega-menu-wrapper">
                	<div class="vd_mega-menu">
        				<?php include(resource_path('views')."/templates/navbars/navbar-tabs-menu.blade.php") ?>                    	
                    </div>                
                </div>
            </div>                                                   
    </div>
	<div class="navbar-menu clearfix">
        ...
        <div class="vd_menu">
        	<?php include(resource_path('views')."/templates/navbars/navbar-menu-".$navbar_menu.".blade.php") ?>
        </div>             
    </div>
