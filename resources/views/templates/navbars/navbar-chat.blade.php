<div class="vd_navbar vd_nav-width vd_navbar-chat vd_bg-black-80 <?php if (isset($current_navbar)) {echo($current_navbar);} ?>  <?php if (isset($current_navbar) && $current_navbar=="vd_navbar-left") {echo($navbar_left_extra_class);} ?> <?php if (isset($current_navbar) && $current_navbar=="vd_navbar-right") {echo($navbar_right_extra_class);} ?>">
	...
	<div class="navbar-menu clearfix">
    	<div class="content-list content-image content-chat">
            <ul class="list-wrapper no-bd-btm pd-lr-10">
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-2.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-3.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-4.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-5.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-6.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-7.jpg'); ?>" alt="example image"></div> 
                ...
                <li>  
                    <a href="#"> 
                            <div class="menu-icon"><img src="<?php echo asset('img/avatar/avatar-8.jpg'); ?>" alt="example image"></div> 
