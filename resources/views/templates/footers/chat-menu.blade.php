<ul class="mega-ul">
    ...
    <li class="one-big-icon mega-li mgl-10"> 
      <a href="index.php" class="mega-link" data-action="click-trigger">
    	<span class="mega-icon"><img alt="example image" src="<?php echo asset('img/avatar/avatar.jpg'); ?>"></span> 
    ...
    <li class="one-big-icon mega-li mgl-10"> 
      <a href="index.php" class="mega-link" data-action="click-trigger">
    	<span class="mega-icon"><img alt="example image" src="<?php echo asset('img/avatar/avatar-10.jpg'); ?>"></span> 
